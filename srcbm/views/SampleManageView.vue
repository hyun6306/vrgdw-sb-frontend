  ...
  <div class="wrap">
    ...
    <div class="container">
      <div class="quote_list_contents">
        <!-- <div class="quote_section" :style="`height:${quote_box_height}`">
          <div class="quote_box" ref="quote_box_height" :style="`height:${quote_box_height}`">
            <div class="qb_head">
              ...
              <button class="btn_item_num">아이템 건수 <i>1000</i></button>
        ...
        <swiper class="quote_section swiper" :options="swiperOption" ref="swiper" v-for="index in 1" :key="index">
      ...
      <div class="bottom_select_result_contents">
        <div class="btn_box">
          ...
          <button class="btn_tempsave">샘플요청확정</button>
        </div>
      </div>
    </div>
    <!-- //컨텐츠 바디 -->
