...
import TransportCostInquiryRequest from '@wb/views/transport-cost-inquiry/TransportCostInquiryRequest.vue';

export default {
  components: { TransportCostInquiryRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '운송비 조회', content: 'TransportCostInquiryRequest', key: 'TransportCostInquiryRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'TransportCostInquiryRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
