...
import QuoteDetailRequest from '@wb/views/quote-detail/QuoteDetailRequest.vue';

export default {
  components: { QuoteDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '견적상세', content: 'QuoteDetailRequest', key: 'QuoteDetailRequest' },
