...
import PartnerMRequest from '@wb/views/master/partner-manage/PartnerMRequest.vue';

export default {
  components: { PartnerMRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '파트너관리', content: 'PartnerMRequest', key: 'PartnerMRequest' },
