...
import TreeManageRequest from '@wb/views/master/treemanage/TreeManageRequest.vue';

export default {
  components: { TreeManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '계층구조관리', content: 'TreeManageRequest', key: 'TreeManageRequest' },
