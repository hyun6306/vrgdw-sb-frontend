...
import AdUserRequest from '@wb/views/master/aduser/AdUserRequest.vue';

export default {
  components: { AdUserRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'AD사용자관리', content: 'AdUserRequest', key: 'AdUserRequest' },
