...
import StandardShippingRequest from '@wb/views/master/standardshipping/StandardShippingRequest.vue';

export default {
  components: { StandardShippingRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '표준배송납기관리', content: 'StandardShippingRequest', key: 'StandardShippingRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'StandardShippingRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
