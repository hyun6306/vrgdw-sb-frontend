...
import ItemGroupRequest from '@wb/views/master/itemgroup/ItemGroupRequest.vue';

export default {
  components: { ItemGroupRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '품목군별 담당영업사원관리', content: 'ItemGroupRequest', key: 'ItemGroupRequest' },
