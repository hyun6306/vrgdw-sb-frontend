...
import TransportAreaRequest from '@wb/views/master/transportarea/TransportAreaRequest.vue';

export default {
  components: { TransportAreaRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '운송권역관리', content: 'TransportAreaRequest', key: 'TransportAreaRequest' },
