...
import AdUserRRequest from '@wb/views/master/aduser-regist/AdUserRRequest.vue';

export default {
  components: { AdUserRRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '사용자등록', content: 'AdUserRRequest', key: 'AdUserRRequest' },
