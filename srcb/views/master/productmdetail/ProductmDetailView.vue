...
import ProductmDetailRequest from '@wb/views/master/productmdetail/ProductmDetailRequest.vue';

export default {
  components: { ProductmDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '제품관리 상세', content: 'ProductmDetailRequest', key: 'ProductmDetailRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'ProductmDetailRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
