...
import PartnerRRequest from '@wb/views/master/partner-regist/PartnerRRequest.vue';

export default {
  components: { PartnerRRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '파트너등록', content: 'PartnerRRequest', key: 'PartnerRRequest' },
