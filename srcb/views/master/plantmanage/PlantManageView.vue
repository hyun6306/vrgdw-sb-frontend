...
import PlantManageRequest from '@wb/views/master/plantmanage/PlantManageRequest.vue';

export default {
  components: { PlantManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '플랜트관리', content: 'PlantManageRequest', key: 'PlantManageRequest' },
