...
import SpecialItemInfoRequest from '@wb/views/master/specialiteminfo/SpecialItemInfoRequest.vue';

export default {
  components: { SpecialItemInfoRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '특성항목정보', content: 'SpecialItemInfoRequest', key: 'SpecialItemInfoRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'SpecialItemInfoRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
