<template>
  <div>
        ...
        <div class="search_box_filter">
          <div class="filter_list">
            <label for="" class="filter_type">
              <span class="filter_type_title">특성항목</span>
    ...
    <!-- 리얼그리드 -->
    <div class="realgrid_container_row" style="height: calc(100% - 56px)">
      <div class="realgrid_container realgrid_container14 realgrid_container_half">
        <div class="real_head">
