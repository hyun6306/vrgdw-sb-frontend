...
import CalendarRequest from '@wb/views/master/calendar/CalendarRequest.vue';

export default {
  components: { CalendarRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '휴일달력관리', content: 'CalendarRequest', key: 'CalendarRequest' },
