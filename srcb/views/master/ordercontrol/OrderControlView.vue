...
import OrderControlRequest from '@wb/views/master/ordercontrol/OrderControlRequest.vue';

export default {
  components: { OrderControlRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '주문제어품목관리', content: 'OrderControlRequest', key: 'OrderControlRequest' },
