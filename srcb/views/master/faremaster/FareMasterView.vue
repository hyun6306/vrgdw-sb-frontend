...
import FareMasterRequest from '@wb/views/master/faremaster/FareMasterRequest.vue';

export default {
  components: { FareMasterRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '운임마스터', content: 'FareMasterRequest', key: 'FareMasterRequest' },
