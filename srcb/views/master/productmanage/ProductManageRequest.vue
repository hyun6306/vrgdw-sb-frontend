<template>
  <div>
      ...
      <div class="search_box" ref="search_box_height" :class="{ search_close_01: searchOpen }" :style="`height:${search_box_height}`">
        <div class="search_box_filter always_exposure">
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">제품군</span>
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">제품레벨분류</span>
              <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="선택"></MultiSelect>
            </label>
        ...
        <div class="search_box_filter f_action c_action02">
          <div class="filter_list">
            <label for="" class="filter_type">
              <span class="filter_type_title">제품레벨 1</span>
              <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="선택"></MultiSelect>
            </label>
            <label for="" class="filter_type">
              <span class="filter_type_title">제품레벨 2</span>
              <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="선택"></MultiSelect>
            </label>
            <label for="" class="filter_type">
              <span class="filter_type_title">운영구분</span>
              <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="선택"></MultiSelect>
            </label>
        ...
        <div class="search_box_filter f_action c_action01">
          <div class="filter_list">
            <label for="" class="filter_type filter_type_double">
              ...
              <div class="form_input">
                <input type="text" class="w_100" style="" id="" placeholder="" />
              </div>
            </label>
          </div>
        </div>
    ...
    <div :class="[searchOpen ? 'realgrid_container realgrid_container09' : 'realgrid_container realgrid_container09 padding-on']">
      ...
      <div class="real_body real_body11">
      ...
      <!-- <div class="real_footer">
        <div class="footer_left">
          <button class="btn_default btn_ref">엑셀 다운로드</button>
        </div>
        <div class="footer_right">
          <button class="btn_default">담당지정</button>
          <button class="btn_default btn_quta">저장</button>
        </div>
      </div> -->
    </div>
    <!-- //리얼그리드 -->
