...
import ProductManageRequest from '@wb/views/master/productmanage/ProductManageRequest.vue';

export default {
  components: { ProductManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '제품관리', content: 'ProductManageRequest', key: 'ProductManageRequest' },
