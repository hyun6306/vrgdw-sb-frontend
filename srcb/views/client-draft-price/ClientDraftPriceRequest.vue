    ...
    <div class="search_content">
      <div class="search_box">
        <div class="search_box_filter">
          <div class="filter_list">
            <label for="" class="filter_type">
              ...
              <div class="form_inputnbtn essential">
                <input type="text" id="custoer_name" style="" class="t-l" placeholder="" />
                <button class="btn_search_basic_info"><img src="@/assets/img/icon_search.png" /></button>
              </div>
            </label>
            <label for="" class="filter_type">
              <span class="filter_type_title">품목</span>
              <MultiSelect v-model="value" style="width: 100%" :options="options" :multiple="true" track-by="library" :custom-label="customLabel" :close-on-select="false" :show-labels="false"> </MultiSelect>
            </label>
            <label for="" class="filter_type">
              <span class="filter_type_title">키워드</span>
              <!-- 데이터피커 -->
              <div class="form_inputnbtn">
                <input type="text" style="" id="custoer_name" placeholder="제품코드를 입력해주세요." />
                <button class="btn_search_basic_info"><img src="@/assets/img/icon_search.png" /></button>
              </div>
            </label>
          ...
          <div class="filter_list">
            <label for="" class="filter_type">
              <span class="filter_type_title">기간</span>
              <!-- 데이터피커 -->
    ...
    <div class="realgrid_container realgrid_container06">
      ...
      <div class="real_footer">
        <div class="footer_left">
          ...
          <button class="btn_default btn_white">Excel Upload</button>
        </div>
        <div class="footer_right">
          <button class="btn_default btn_temp">기안문서번호 등록</button>
        </div>
      </div>
    </div>
    <!-- //리얼그리드 -->
