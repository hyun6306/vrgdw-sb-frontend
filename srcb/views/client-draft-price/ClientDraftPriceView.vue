...
import ClientDraftPriceRequest from '@wb/views/client-draft-price/ClientDraftPriceRequest.vue';

export default {
  components: { ClientDraftPriceRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '거래처별 적용판가관리', content: 'ClientDraftPriceRequest', key: 'ClientDraftPriceRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'ClientDraftPriceRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
