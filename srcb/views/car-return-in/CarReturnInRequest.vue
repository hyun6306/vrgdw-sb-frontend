      ...
      <div class="search_box" ref="search_box_height" :class="{ search_close_01: searchOpen }" :style="`height:${search_box_height}`">
        <div class="search_box_filter always_exposure">
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">대리점</span>
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">
                <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="주문일자"></MultiSelect>
              </span>
              <!-- 데이터피커 -->
        ...
        <div class="search_box_filter f_action c_action02">
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">제품</span>
              <div class="form_inputnbtn">
                <input type="text" style="" id="custoer_name" placeholder="" />
                <button class="btn_search_basic_info"><img src="@/assets/img/icon_search.png" /></button>
              </div>
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">반품진행상태</span>
        ...
        <div class="search_box_filter f_action c_action01">
          <div class="filter_list">
            <label for="" class="filter_type">
              ...
              <MultiSelect id="Material_Group" class="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="전체"></MultiSelect>
            </label>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getInfoHeight() {
      ...
      let val = this.$refs.search_box_height.scrollHeight + 6;
