...
import CarReturnInRequest from '@wb/views/car-return-in/CarReturnInRequest.vue';

export default {
  components: { CarReturnInRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '반품 입고수량 확정', content: 'CarReturnInRequest', key: 'CarReturnInRequest' },
