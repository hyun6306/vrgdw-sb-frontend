  ...
  <div>
      ...
      <div class="search_box" ref="search_box_height" :class="{ search_close: searchOpen }" :style="`height:${search_box_height}`">
        <div class="search_box_filter">
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">Material Group</span>
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">Status</span>
          ...
          <div class="filter_list">
            <label for="" class="filter_type filter_type_double">
              ...
              <div class="form_inputnbtn">
                <input type="text" id="" class="t-l" placeholder="" />
        ...
        <div class="search_box_filter">
          <div class="filter_list">
            ...
            <label for="custoer_name" class="filter_type">
              ...
              <div class="form_inputnbtn">
                <input type="text" style="width: 159px" id="custoer_name" placeholder="Customer A" />
                <button class="btn_search_basic_info"><img src="@/assets/img/icon_search.png" /></button>
              </div>
            </label>
            <label for="" class="filter_type">
              <span class="filter_type_title">품목</span>
              <MultiSelect id="Material_Group" style="width: 160px" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="Pick a value"></MultiSelect>
            </label>
            <label for="" class="filter_type">
              <span class="filter_type_title">Status</span>
              <MultiSelect v-model="value" style="width: 156px" :options="options" :multiple="true" track-by="library" :custom-label="customLabel" :close-on-select="false" :show-labels="false">
                <label class="chechbox_select" slot="option" slot-scope="scope">
                  <input class="select-checkbox" type="checkbox" :checked="isSelected(scope.option)" @focus.prevent :key="scope.option.library" />
                  <span class="checkmark"></span>
                  {{ scope.option.library }}
          ...
          <div class="filter_list">
            <label for="" class="filter_type">
              <span class="filter_type_title">Keyword</span>
              <input type="text" id="postal_code" style="width: 170px" class="t-r" placeholder="000000" />
    ...
    <div class="realgrid_container realgrid_container07">
      ...
      <div class="real_body real_body05">
        <CustomerOrderGrid style="height: 100%" :gridName="'BookingOrder'" @openSingleCalendar="openSingleCalendar" :selectMonth="selectMonth" />
      </div>
      <div class="real_footer">
        <div class="footer_left">
          ...
          <!-- //drop down -->
          <button class="btn_default btn_white">Booking Upload</button>
        ...
        <div class="footer_right">
          ...
          <button class="btn_default btn_temp">잔량종료</button>
