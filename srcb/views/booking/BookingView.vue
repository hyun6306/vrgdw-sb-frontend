...
import BookingRequest from '@wb/views/booking/BookingRequest.vue';

export default {
  components: { BookingRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '부킹상세', content: 'BookingRequest', key: 'BookingRequest' },
