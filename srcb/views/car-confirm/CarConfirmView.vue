...
import CarConfirmRequest from '@wb/views/car-confirm/CarConfirmRequest.vue';

export default {
  components: { CarConfirmRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '배차 확정관리', content: 'CarConfirmRequest', key: 'CarConfirmRequest' },
