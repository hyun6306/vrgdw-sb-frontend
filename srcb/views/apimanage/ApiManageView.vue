...
import ApiManageRequest from '@wb/views/apimanage/ApiManageRequest.vue';

export default {
  components: { ApiManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'API관리', content: 'ApiManageRequest', key: 'ApiManageRequest' },
