...
import ShippinglistRequest from '@wb/views/shipping-list/ShippinglistRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { ShippinglistRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.ShippinglistRequest', content: 'ShippinglistRequest', key: 'ShippinglistRequest' },
