...
import ManualRequest from '@wb/views/manual/ManualRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { ManualRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.ManualRequest', content: 'ManualRequest', key: 'ManualRequest' },
