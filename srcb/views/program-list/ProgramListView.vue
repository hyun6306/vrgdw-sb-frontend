...
import ProgramListRequest from '@wb/views/program-list/ProgramListRequest.vue';

export default {
  components: { ProgramListRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '프로그램 목록', content: 'ProgramListRequest', key: 'ProgramListRequest' },
