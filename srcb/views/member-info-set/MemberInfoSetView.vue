...
import MemberInfoSetRequest from '@wb/views/member-info-set/MemberInfoSetRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { MemberInfoSetRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.MemberInfoSetRequest', content: 'MemberInfoSetRequest', key: 'MemberInfoSetRequest' },
