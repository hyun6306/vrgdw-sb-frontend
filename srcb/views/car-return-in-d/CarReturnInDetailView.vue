...
import CarReturnInDetailRequest from '@wb/views/car-return-in-d/CarReturnInDetailRequest.vue';

export default {
  components: { CarReturnInDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '반품 입고 상세', content: 'CarReturnInDetailRequest', key: 'CarReturnInDetailRequest' },
