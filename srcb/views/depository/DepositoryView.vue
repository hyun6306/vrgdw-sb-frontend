...
import DepositoryRequest from '@wb/views/depository/DepositoryRequest.vue';

export default {
  components: { DepositoryRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '예탁처리', content: 'DepositoryRequest', key: 'DepositoryRequest' },
