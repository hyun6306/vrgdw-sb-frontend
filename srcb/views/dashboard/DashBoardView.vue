...
import DashBoardRequest from '@wb/views/dashboard/DashBoardRequest.vue';

export default {
  components: { DashBoardRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '대쉬보드', content: 'DashBoardRequest', key: 'DashBoardRequest' },
