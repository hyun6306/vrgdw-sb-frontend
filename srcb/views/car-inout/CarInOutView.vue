...
import CarInOutRequest from '@wb/views/car-inout/CarInOutRequest.vue';

export default {
  components: { CarInOutRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '입/출차관리', content: 'CarInOutRequest', key: 'CarInOutRequest' },
