...
import ManageDetailRequest from '@wb/views/quote-manage-detail/ManageDetailRequest.vue';

export default {
  components: { ManageDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '견적관리상세', content: 'ManageDetailRequest', key: 'ManageDetailRequest' },
