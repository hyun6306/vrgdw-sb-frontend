...
import DispatchPoRequest from '@wb/views/dispatch-po/DispatchPoRequest.vue';

export default {
  components: { DispatchPoRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'PO출고 요청관리', content: 'DispatchPoRequest', key: 'DispatchPoRequest' },
