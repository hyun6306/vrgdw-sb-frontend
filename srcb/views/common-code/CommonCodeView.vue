...
import CommonCodeRequest from '@wb/views/common-code/CommonCodeRequest.vue';

export default {
  components: { CommonCodeRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '공통코드관리', content: 'CommonCodeRequest', key: 'CommonCodeRequest' },
