<template>
  <div>
    ...
    <canvas id="myCanvas" width="360" height="360" v-touch:start="beginDrawing" v-touch:moving="keepDrawing" v-touch:end="stopDrawing" />
...
export default {
  ...
  methods: {
    ...
    save() {
      var dataurl = this.realCanvas.toDataURL('image/png');
