...
import CarRequestRequest from '@wb/views/car-request/CarRequestRequest.vue';

export default {
  components: { CarRequestRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '배차 요청관리', content: 'CarRequestRequest', key: 'CarRequestRequest' },
