        ...
        <div class="search_box_filter">
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              ...
              <input type="text" id="" style="width: 100%" class="disabled t-l" disabled placeholder="" />
            </label>
            <label for="" class="filter_type">
    ...
    <div class="realgrid_container realgrid_container06">
      <div class="real_head">
        <div class="real_head_left">
          ...
          <small class="ml-30">주문수량 <i>4</i></small>
      ...
      <div class="real_footer">
        ...
        <div class="footer_right">
          ...
          <button class="btn_default btn_temp">배차완료</button>
        </div>
      </div>
    </div>
    <!-- //리얼그리드 -->
