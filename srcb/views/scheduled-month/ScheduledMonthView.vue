...
import ScheduledMonthRequest from '@wb/views/scheduled-month/ScheduledMonthRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { ScheduledMonthRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '예정월관리', content: 'ScheduledMonthRequest', key: 'ScheduledMonthRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'ScheduledMonthRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
