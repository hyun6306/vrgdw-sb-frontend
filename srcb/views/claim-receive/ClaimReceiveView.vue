...
import ClaimReceiveRequest from '@wb/views/claim-receive/ClaimReceiveRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { ClaimReceiveRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '접수관리', content: 'ClaimReceiveRequest', key: 'ClaimReceiveRequest' },
