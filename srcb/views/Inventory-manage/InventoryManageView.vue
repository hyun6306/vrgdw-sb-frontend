...
import InventoryManageRequest from '@wb/views/Inventory-manage/InventoryManageRequest.vue';

export default {
  components: { InventoryManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '재고할당관리', content: 'InventoryManageRequest', key: 'InventoryManageRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'InventoryManageRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
