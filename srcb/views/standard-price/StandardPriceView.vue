...
import StandardPriceRequest from '@wb/views/standard-price/StandardPriceRequest.vue';

export default {
  components: { StandardPriceRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '기준판가관리', content: 'StandardPriceRequest', key: 'StandardPriceRequest' },
