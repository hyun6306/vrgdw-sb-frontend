...
import ClientDetailRequest from '@wb/views/client-detail/ClientDetailRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { ClientDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.ClientDetailRequest', content: 'ClientDetailRequest', key: 'ClientDetailRequest' },
