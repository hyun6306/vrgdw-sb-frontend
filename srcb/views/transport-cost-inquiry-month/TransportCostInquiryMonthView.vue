...
import TransportCostInquiryMonthRequest from '@wb/views/transport-cost-inquiry-month/TransportCostInquiryMonthRequest.vue';

export default {
  components: { TransportCostInquiryMonthRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '운송비 월마감 조회', content: 'TransportCostInquiryMonthRequest', key: 'TransportCostInquiryMonthRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'TransportCostInquiryMonthRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
