...
import ManageRequest from '@wb/views/quote-manage/ManageRequest.vue';

export default {
  components: { ManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '견적관리', content: 'ManageRequest', key: 'ManageRequest' },
