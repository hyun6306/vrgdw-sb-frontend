...
import TermsRequest from '@wb/views/terms/TermsRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { TermsRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.TermsRequest', content: 'TermsRequest', key: 'TermsRequest' },
