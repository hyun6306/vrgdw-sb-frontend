...
import DeliveryStatusRequest from '@wb/views/delivery-status/DeliveryStatusRequest.vue';

export default {
  components: { DeliveryStatusRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '배송현황', content: 'DeliveryStatusRequest', key: 'DeliveryStatusRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'DeliveryStatusRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
