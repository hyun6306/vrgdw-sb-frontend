...
import ClientListRequest from '@wb/views/client-list/ClientListRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { ClientListRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.ClientListRequest', content: 'ClientListRequest', key: 'ClientListRequest' },
