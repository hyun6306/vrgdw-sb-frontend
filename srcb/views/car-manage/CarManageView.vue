...
import CarManageRequest from '@wb/views/car-manage/CarManageRequest.vue';

export default {
  components: { CarManageRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '차량관리', content: 'CarManageRequest', key: 'CarManageRequest' },
