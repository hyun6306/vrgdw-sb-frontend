...
import ProgramRequest from '@wb/views/program/ProgramRequest.vue';

export default {
  components: { ProgramRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '프로그램관리', content: 'ProgramRequest', key: 'ProgramRequest' },
