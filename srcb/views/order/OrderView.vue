...
import GeneralRequest from '@wb/views/order/GeneralRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { GeneralRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.orderGeneralRequest', content: 'GeneralRequest', key: 'GeneralRequest' },
