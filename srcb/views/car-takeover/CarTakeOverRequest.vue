          ...
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">
                <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="출차일"></MultiSelect>
              </span>
              <!-- 데이터피커 -->
    ...
    <div class="realgrid_container realgrid_container06">
      ...
      <div class="real_footer">
        ...
        <div class="footer_right">
          <button class="btn_default btn_temp">전자송장출력</button>
          <button class="btn_default btn_temp">인수확인</button>
        </div>
      </div>
    </div>
    <!-- //리얼그리드 -->
