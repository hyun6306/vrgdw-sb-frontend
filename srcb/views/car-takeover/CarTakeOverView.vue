...
import CarTakeOverRequest from '@wb/views/car-takeover/CarTakeOverRequest.vue';

export default {
  components: { CarTakeOverRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '인수관리', content: 'CarTakeOverRequest', key: 'CarTakeOverRequest' },
