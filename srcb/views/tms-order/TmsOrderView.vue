...
import TmsOrderRequest from '@wb/views/tms-order/TmsOrderRequest.vue';

export default {
  components: { TmsOrderRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'TMS 주문상태조회', content: 'TmsOrderRequest', key: 'TmsOrderRequest' },
