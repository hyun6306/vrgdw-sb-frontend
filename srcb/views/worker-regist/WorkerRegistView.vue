...
import WorkerRegistRequest from '@wb/views/worker-regist/WorkerRegistRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { WorkerRegistRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.WorkerRegistRequest', content: 'WorkerRegistRequest', key: 'WorkerRegistRequest' },
