...
import WorkerlistRequest from '@wb/views/worker-list/WorkerlistRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { WorkerlistRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.WorkerlistRequest', content: 'WorkerlistRequest', key: 'WorkerlistRequest' },
