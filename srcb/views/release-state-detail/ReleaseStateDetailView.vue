...
import ReleaseStateDetailRequest from '@wb/views/release-state-detail/ReleaseStateDetailRequest.vue';

export default {
  components: { ReleaseStateDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '출고 현황 세부내역', content: 'ReleaseStateDetailRequest', key: 'ReleaseStateDetailRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'ReleaseStateDetailRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
