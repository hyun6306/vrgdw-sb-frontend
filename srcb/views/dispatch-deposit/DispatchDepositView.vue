...
import DispatchDepositRequest from '@wb/views/dispatch-deposit/DispatchDepositRequest.vue';

export default {
  components: { DispatchDepositRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '예탁출고요청관리', content: 'DispatchDepositRequest', key: 'DispatchDepositRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'DispatchDepositRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
