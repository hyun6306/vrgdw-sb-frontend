      ...
      <div class="search_box">
        <div class="search_box_filter">
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">조회대상</span>
              <MultiSelect v-model="value" style="width: 100%" :options="options" :multiple="true" track-by="library" :custom-label="customLabel" :close-on-select="false" :show-labels="false" placeholder="예탁처리대상">
    ...
    <div class="realgrid_container realgrid_container09">
      ...
      <div class="real_footer">
        ...
        <div class="footer_right">
          <button class="btn_default btn_temp">예탁출고 확정취소</button>
          <button class="btn_default btn_temp">예탁출고 확정</button>
        </div>
      </div>
    </div>
    <!-- //리얼그리드 -->
