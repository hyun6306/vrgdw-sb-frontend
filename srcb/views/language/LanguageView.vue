...
import LanguagePage from '@wb/views/language/LanguagePage';
import LanguageLang from '@wb/views/language/LanguageLang';

export default {
  components: { LanguagePage, LanguageLang, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '다국어 단어사전', content: 'LanguageLang', key: 'LanguageLang' },
      { title: '다국어 주소 설정', content: 'LanguagePage', key: 'LanguagePage' },
