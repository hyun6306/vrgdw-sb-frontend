...
import PrivacyRequest from '@wb/views/privacy/PrivacyRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { PrivacyRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.PrivacyRequest', content: 'PrivacyRequest', key: 'PrivacyRequest' },
