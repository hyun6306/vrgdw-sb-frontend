...
import SampleDetailRequest from '@wb/views/sample-detail/SampleDetailRequest.vue';

export default {
  components: { SampleDetailRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '샘플상세', content: 'SampleDetailRequest', key: 'SampleDetailRequest' },
