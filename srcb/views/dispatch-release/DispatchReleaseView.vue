...
import DispatchReleaseRequest from '@wb/views/dispatch-release/DispatchReleaseRequest.vue';

export default {
  components: { DispatchReleaseRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '출고 요청관리', content: 'DispatchReleaseRequest', key: 'DispatchReleaseRequest' },
    ...
    return {
      ...
      panes,
      newTabIndex: 0,
      selected: 'DispatchReleaseRequest',
      isMainShow: true,
      currentTab: 0,
      main: {
        content: 'DashBoard',
