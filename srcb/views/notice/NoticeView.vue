...
import NoticeRequest from '@wb/views/notice/NoticeRequest.vue';
// import DevFooter from '@/components/DevFooter.vue';

export default {
  components: { NoticeRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: 'label.NoticeRequest', content: 'NoticeRequest', key: 'NoticeRequest' },
