          ...
          <div class="filter_list">
            ...
            <label for="" class="filter_type">
              <span class="filter_type_title">
                <MultiSelect id="" style="width: 100%" v-model="selectValue" :options="selectOptions" :searchable="false" :close-on-select="false" :show-labels="false" placeholder="배차 확정일"></MultiSelect>
              </span>
              <!-- 데이터피커 -->
      ...
      <div class="realgrid_container realgrid_container_half" style="height: 300px">
        <div class="real_head">
          <div class="real_head_left">
            <small>운송사별 운송비 총<i>4</i>건</small>
          </div>
    ...
    <div class="realgrid_container realgrid_container13">
      ...
      <div class="real_footer">
        ...
        <div class="footer_right">
          <button class="btn_default btn_temp">운송비 조정</button>
          <button class="btn_default btn_temp">마감</button>
          <div class="btn_default btn_temp btn_deadline">
            <div class="form_calendar">
              <input type="text" placeholder="달 선택" />
              <button class="icon_calendar" @click="datePicker('DateMonthPicker')"><img src="@/assets/img/icon_calendar.png" /></button>
            </div>
          </div>

          <button class="btn_default btn_temp">마감취소</button>
        </div>
      </div>
    </div>
    <!-- //리얼그리드 -->
