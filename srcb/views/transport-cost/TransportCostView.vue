...
import TransportCostRequest from '@wb/views/transport-cost/TransportCostRequest.vue';

export default {
  components: { TransportCostRequest, SampleTwo, DashBoard },
  data() {
    const panes = [
      { title: '운송비 관리', content: 'TransportCostRequest', key: 'TransportCostRequest' },
