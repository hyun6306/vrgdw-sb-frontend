<template>
  <modal name="SalesSearchModal" width="1210" height="600" :adaptive="true" @before-close="close">
    <div class="modal">
      <div slot="top-right" class="btn_modal_close_t02">
        <button @click="$modal.hide('SalesSearchModal')"></button>
      </div>
      <p class="modal_title_t02">영업사원 검색</p>
