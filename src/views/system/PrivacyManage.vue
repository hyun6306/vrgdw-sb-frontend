    ...
    <div class="realgrid_container realgrid_container17">
      <div class="real_head">
        <div class="real_head_left">
          <span class="real_title">{{ $t('message.privacyAgree') }}</span>
        </div>
      ...
      <div class="real_footer">
        ...
        <div class="footer_right">
          <button class="btn_default btn_process" @click="$modal.show('PrivacyModal', { page: 'PRIVACY', id: null })">{{ $t('message.btnRegist') }}</button>
...
export default {
  ...
  methods: {
    ...
    privacyDetail(id) {
      //세부내용 모달로 이동
      this.$modal.show('PrivacyModal', { page: 'PRIVACY', id: id });
    },
    async privacyRemove() {
      //삭제
