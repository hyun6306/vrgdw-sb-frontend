...
export default {
  ...
  watch: {
    productFavoriteList() {
      if (this.realGrid) {
        this.setData();
        this.realGrid.dataProvider.setRows(this.productFavoriteList);
      }
    },
    gridLang() {
      this.initGrid();
  ...
  methods: {
    ...
    onItemAllChecked(grid, checked) {
      ...
      this.$emit('sendCheckedCount', 'favorite', checkedRows.length);
    },
    onItemChecked(grid, itemIndex, checked) {
      ...
      this.$emit('sendCheckedCount', 'favorite', this.checkedCount);
    },
    clearCheckCount() {
      if (this.realGrid) {
    ...
    setData() {
      this.productFavoriteList.forEach(list => {
