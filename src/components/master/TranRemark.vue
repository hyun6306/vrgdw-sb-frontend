    ...
    <div class="master_form">
      <div class="product_detail_info_section">
        <div class="product_di_box product_di_box04">
          <h2 class="mypage_title">{{ $t('message.trncusRemark') }}</h2>
        ...
        <div class="product_di_box product_di_box04">
          <h2 class="mypage_title">
            ...
            <div class="btn_s_default btn_function" v-if="authButton.fn2Auth == 'Y'">
              <input type="file" ref="files" name="images" style="display: none" id="inputFileTran" @change="getval()" />
              <label for="inputFileTran" class="btn_regist" style="float: right">{{ $t('message.btnUpload') }}</label>
            </div>
          </h2>
