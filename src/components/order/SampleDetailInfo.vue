    ...
    <div class="search_box" ref="search_box_height" :class="{ search_close_00: searchOpen }" :style="`height:${search_box_height}`">
      <div class="search_box_filter">
          ...
          <div class="table_box" style="width: 100%">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <th class="t-l">{{ $t('message.sampleDate') }}</th>
                ...
                <tr>
                  <th class="t-l">{{ $t('message.sampleNum') }}</th>
                  <td class="t-r">
                    <!-- @click="loadOrderPage" -->
                    {{ offrInfo.offrNum }}
                  </td>
        ...
        <div class="table_section">
          ...
          <!-- 사용자 일 경우 노출 -->
          <div class="table_box" style="width: 800px" v-if="this.authButton.schAuth == 'Y'">
            <table>
              <colgroup>
                <col style="width: 40%" />
                <col style="width: 60%" />
      ...
      <div class="search_box_filter btn_box">
        <!-- <button class="btn_default btn_white" :disabled="this.offrInfo.offrStatCd == ('CAN' || 'REQ')" @click="print('quote')">
          {{ $t('message.btnPrintQuotation') }}
        </button> -->
        <!-- <button class="btn_default btn_white" :disabled="this.offrInfo.offrStatCd == ('CAN' || 'REQ')" @click="print('contract')">
        ...
        <!-- <button class="btn_default btn_white" @click="$parent.offrMng('copy')">
...
export default {
  props: ['offrInfo', 'userInfo', 'page', 'menuId', 'canQtyTotal', 'layoutData', 'authButton', 'openInfo'],
  components: {
    // QuoteDetailModal,
