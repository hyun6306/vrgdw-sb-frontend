<template>
  <modal name="SampleAddressInfoModal" width="900" height="auto" @opened="getAddrInfo()" :clickToClose="false">
    <div class="modal" id="ShippingAddress">
      <div slot="top-right" class="btn_modal_close_t02">
        <button @click="[$modal.hide('SampleAddressInfoModal')]"></button>
      </div>
      ...
      <div class="modal_content">
        <div class="result_box">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="t-l">{{ userAddrInfo.addr }}</td>
                </tr>
                <tr>
          ...
          <div class="modal_btn_contents_t05">
            <button @click="[$modal.hide('SampleAddressInfoModal')]" class="btn_primary">
              {{ $t('message.btnClose') }}
            </button>
          </div>
        </div>
