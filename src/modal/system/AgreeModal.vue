<template>
  <modal name="AgreeModal" width="750" height="auto" @before-open="open" @before-close="close" :clickToClose="false">
    <div class="modal" id="NoticeRegist">
      <div slot="top-right" class="btn_modal_close_t02">
        <button @click="$modal.hide('AgreeModal')"></button>
      </div>
      <p class="modal_title_t02">{{ $t('message.conditionInfo') }}</p>
      ...
      <div class="modal_btn_contents_t05 mb-20">
        <button class="btn_default" @click="$modal.hide('AgreeModal')">{{ $t('message.btnClose') }}</button>
