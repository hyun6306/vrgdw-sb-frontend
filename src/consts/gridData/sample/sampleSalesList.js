...
export const fields = [
  ...
  },
  {
    ...
    dataType: ValueType.TEXT, // 담당 영업조직
  },
  {
    fieldName: 'salesMngNm',
    dataType: ValueType.TEXT, // 담당 영업사원
  },
  {
...
export const layout = [
  ...
  // 배송완료량 주문단위 변경 =>
  {
    ...
    items: [
      { column: 'trnEndOrdTotQty', groupShowMode: 'expand' }, // 주문, 13
      { column: 'trnEndBaseTotQty', groupShowMode: 'expand' }, // 기본, 14
  ...
  // 배송가능량 주문단위 변경 =>
  {
    ...
    items: [
      { column: 'trnPsbOrdTotQty', groupShowMode: 'expand' }, // 주문, 15
      { column: 'trnPsbBaseTotQty', groupShowMode: 'expand' }, // 기본, 16
  ...
  // 배송중 량 주문단위 변경 =>
  {
    ...
    items: [
      { column: 'trnIngOrdTotQty', groupShowMode: 'expand' }, // 주문, 17
      { column: 'trnIngBaseTotQty', groupShowMode: 'expand' }, // 기본, 18
      { column: 'baseUnitNm5', groupShowMode: 'expand' }, // 단위 매
      { column: 'ordUnitNm5', groupShowMode: 'expand' }, // 단위 번들
    ],
  },
  'custReqRemarkYn', // 고객메모, 19
  // 'salesMngRemarkYn', // 영업메모, 20
  'addrInfo', // 배송지정보, 21
  {
    name: 'salesMngNm',
    direction: 'horizontal',
    ...
    items: [
      { column: 'salesMngNm', groupShowMode: 'always' }, // 영업사원, 22
      { column: 'salesGroup', groupShowMode: 'expand' }, // 영업팀, 23
      { column: 'salesMngPhoneNum', groupShowMode: 'expand' }, // 영업사원 연락처, 24
      { column: 'salesMngEmail', groupShowMode: 'expand' }, // 영업사원 이메일, 25
    ],
  },
  {
    name: 'salesSuptNm',
    ...
    items: [
      { column: 'salesSuptNm', groupShowMode: 'always' }, // 담당 영업지원, 26
      { column: 'salesSuptPhoneNum', groupShowMode: 'expand' }, // 담당 영업지원 연락처, 27
      { column: 'salesSuptEmail', groupShowMode: 'expand' }, // 담당 영업지원 이메일, 28
    ],
  },
  {
    name: 'writerInfo',
    ...
    items: [
      { column: 'createdByNm', groupShowMode: 'always' }, // 생성자, 29
      { column: 'createdByPhone', groupShowMode: 'expand' }, // 생성자 연락처, 30
    ],
  },
  'updatedAt', // 마지막 수정일, 31
  'updatedByNm', // 수정자, 32
  'offrEndDt', // 완료일, 33
];
