...
export const layout = ['id', 'prdtId', 'prdtClsCd', 'prdtCd', 'prdtNm', 'currency', 'aplyPrice', 'rangeDt', 'sttDt', 'endDt', 'apprStat', 'apprDocNum', 'info', 'updatedAt', 'updatedBy', 'updatedByNm'];
