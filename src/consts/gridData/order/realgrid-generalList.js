...
export const layout = [
  ...
  'custPoNum', // P/O번호
  {
    ...
    items: [
      { column: 'trnHopeDt', groupShowMode: 'always' }, // 배송희망일
      { column: 'addrInfo', groupShowMode: 'expand' }, // 배송지정보
    ],
  },
  'prdtItemQty', // 총아이템수
  'currency', // 통화
  'reqTotal',
  {
    ...
    items: [
      { column: 'offrTotal', groupShowMode: 'always' }, // 총금액
      { column: 'offrTotPrice', groupShowMode: 'expand' }, // 금액
      { column: 'offrTotVat', groupShowMode: 'expand' }, // 부가가치세
    ],
  },
  'paymentCond', // 결제조건
  'custReqRemarkYn', // 고객요구사항
  'salesMngRemarkYn', // 영업의견
  'progRate',
  // 견적요청량 주문단위 변경 =>
  {
